...
import participantMainIcon from '../assets/participant/participantMainIcon.svg'
import { btnTypes } from '@bento-core/paginated-table';
import { GET_ALL_FILE_IDS_FOR_BIOSPECIMENS, GET_FILE_IDS_FOR_SELECTED_BIOSPECIMENS } from './dashboardTabData';



export const pageData = {
  participantMainIcon: {
    src: participantMainIcon,
...
*/
  ...
  // API Properties needed to identify Files within the Table or alreaduy loaded data 
  addFilesResponseKeys: ['biospecimen_data_files', 'data_file_uuid'],
  addAllFilesResponseKeys: ['biospecimen_data_files', 'data_file_uuid'],

  // API Properties needed to add Files into Cart 
...
query subjectOverview(
  ...
  participantOverview(
    ...
    primary_disease_site # Need to be Added
    stage_of_disease

    # Targeted Therapy
    targeted_therapy
    # best_response_to_targeted_therapy # Need to be Added # not in DB
  }

    # All Associated Biospecimens
    biospecimenOverview(
      participant_id: $participant_id
      ...
      participant_id,
      age_at_enrollment, # Need to be Added
      sex #Need to be Added
      race # Need to be Added

      surgical_procedure # Need to be Added
      specimen_type
      ctep_disease_term # diagnosis
      stage_of_disease
      tumor_grade # Need to be Added
      targeted_therapy # Need to be Added


    # Other propeties not currently used
      ctep_disease_term,
      stage_of_disease
...
// --------------- GraphQL query - Retrieve Case data --------------
export const GET_CASE_DETAIL_DATA_QUERY_ICDC = gql`
