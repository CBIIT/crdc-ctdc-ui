...
export const STUDY_DETAIL_MAIN_QUERY = gql`
query Study_Detail($csd: String!, $accessionId: String!) {
  ...
  study(
    filter: {OR: [{clinical_study_designation: $csd}, {accession_id: $accessionId}]}
  ) {
    program {
      program_acronym
      __typename
...
export const STUDY_DETAIL_MAIN_QUERY_original = gql`
