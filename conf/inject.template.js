window.injectedEnv = {
    ...
    REACT_APP_LOGIN_CONTENT_URL: '${REACT_APP_LOGIN_CONTENT_URL}',
    ...
    REACT_APP_DATA_MODEL_FILE: '${REACT_APP_DATA_MODEL_FILE}',

    PUBLIC_ACCESS: '${PUBLIC_ACCESS}',
    NODE_LEVEL_ACCESS:'${NODE_LEVEL_ACCESS}',
    NODE_LABEL: '${NODE_LABEL}',

    REACT_APP_FRONTEND_VERSION: '${REACT_APP_FRONTEND_VERSION}',
    REACT_APP_BACKEND_VERSION: '${REACT_APP_BACKEND_VERSION}',
    REACT_APP_AUTH_SERVICE_VERSION: '${REACT_APP_AUTH_SERVICE_VERSION}',
