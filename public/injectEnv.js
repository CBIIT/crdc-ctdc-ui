...
window.injectedEnv = {
  ...
  REACT_APP_FILE_SERVICE_API: 'http://localhost:3010/api/files/',
  REACT_APP_AUTH_SERVICE_API: 'http://localhost:3010/api/auth/',
  REACT_APP_USER_SERVICE_API: 'http://localhost:3010/api/users/',
  ...
  REACT_APP_LOGIN_URL: 'https://nci-crdc-staging.datacommons.io/user/oauth2/authorize?client_id=9daCtorxUg7aJPKFPd2cD4QvWw3AH61lWaKXZqXM&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Flogin&scope=openid%20user',
